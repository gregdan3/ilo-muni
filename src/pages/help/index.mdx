...
> [search page](/). If something is incomplete, out of date, or
...
[**pona**](/?query=pona). If it appeared at least 40 times across all
...
[**Inli**](/?query=inli), or [**Siko**](/?query=Siko). There
...
- See the start and growth of words coined only a few years ago like
  [**tonsi**](/?query=tonsi) or
  [**misikeke**](/?query=misikeke)
...
[**mi kama sona e toki pona**](/?query=mi+kama+sona+e+toki+pona). Note
...
like [**kama pona**](/?query=kama+pona) or
[**anu seme**](/?query=anu+seme).
...
for combining synonyms, like [**ale + ali**](/?query=ale+%2B+ali). You
...
[**toki - toki pona**](/?query=toki+-+toki+pona). This gives you all
...
[**toki_1, toki_6**](/?query=toki,+toki_6) will show you the percentage
...
length of term: [**ona li, ona li_6**](/?query=ona+li,+ona+li_6)

You can use this with subtraction to **isolate a term**: Searching
[**toki - toki_2**](/?query=toki+-+toki_2) will show you every time
...
- See if there is a difference in relative use of words:
  [**toki, pona, toki_6, pona_6**](/?query=toki,+pona,+toki_6,+pona_6).
...
**relative log scale**,
[kijetesantakalu, soweli](/?query=kijetesantakalu,+soweli&scale=logrel)
...
[of very different magnitude](/?query=a,+kin&scale=abs), or to study
...
magnitudes, such as
[kijetesantakalu, soweli](/?query=kijetesantakalu%2C+soweli&scale=rel).
...
popular than another [recently](/?query=kokosila%2C+penpo&scale=rel),
it may not have done so [all-time](/?query=kokosila,+penpo&scale=cmsum)
...
[**5 smoothing**](/?query=wawa,+nasa,+suwi,+sewi,+suli&smoothing=5).
...
happen with a search like [**toki pona_2**](/?query=toki+pona_2)
normally, or [**wawa_3**](/?query=wawa_3&minSentLen=3) while the
